...
export function createAgentPrompt(
  ...
  return [
    ...
    "When genuinely required user input cannot be inferred, return: {\"kind\":\"needs_user\",\"question\":\"...\",\"options\":[\"...\"],\"recommendedOption\":\"...\"}. Give 2-5 concise visible choices when choices are available, recommend the best one, and ensure recommendedOption exactly matches one option.",
    ...
    "Use click for buttons and button-like controls, even when their text says Submit, Pay, Confirm, or Top Up. Use submit only when targetRef is the native form element itself.",
